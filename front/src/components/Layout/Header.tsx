...
export function Header() {
  return (
    <header className="h-12 border-b flex items-center justify-between px-4" style={{ borderColor: 'var(--border-color)', backgroundColor: 'var(--bg-primary)' }}>
      <div className="flex items-center gap-2">
        <OctoClawLogo />
        <h1 className="font-bold text-lg" style={{ color: 'var(--text-primary)' }}>OctoClaw</h1>
      </div>
      <ThemeToggle />
    </header>
  )
